package zad1;// Fig. 7.10: DeckOfCards.java
...
public class DeckOfCards
{
   ...
   private int numbersOfPairs(int[] numbers) {
      int numberOfPairs = 0;
   ...
   private int numbersOfThree(int[] numbers) {
      for (int i = 0; i < numbers.length; i++) {
         if (numbers[i] == 3) {
            return 1;
         }
   ...
   public boolean hasPair(Card[] hand) {
        ...
        return numbersOfPairs(numbers) == 1 && numbersOfThree(numbers) == 0;
   }

   public boolean hasTwoPair(Card[] hand) {
      int[] numbers = numbers(hand);
      return numbersOfPairs(numbers) == 2 && numbersOfThree(numbers) == 0;
   }

   public boolean hasThreeOfAKind(Card[] hand) {
      int[] numbers = numbers(hand);
      return numbersOfPairs(numbers) == 0 && numbersOfThree(numbers) == 1;
   }
   ...
   public boolean hasFullHouse(Card[] hand) {
      int[] numbers = numbers(hand);
      return numbersOfPairs(numbers) == 1 && numbersOfThree(numbers) == 1;
   }
